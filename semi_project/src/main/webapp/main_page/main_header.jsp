		...
		<header class="main-header py-3">
			<div
				...
				<div class="col-4 pt-1">
					...
					<a class="link-secondary head-right-line" href="#">마이페이지</a>
				</div>
				...
				<div class="col-4 d-flex justify-content-end align-items-center">
					...
					<a class="link-secondary head-right-line" href="#"> <img
						src="<%=request.getContextPath()%>/images/icon/icons8-heart.png"
						width="25" height="25"></a> <a
						class="link-secondary head-right-line" href="#"> <img
		...
		<div class="nav-scroller py-1 mb-2">
			<nav class="nav d-flex justify-content-between">
				<a class="navbar-brand" href="#"><img
					...
					width="25">파이&쿠키</a> <a class="navbar-brand" href="#"><img
					...
					width="25">초콜릿</a> <a class="navbar-brand" href="#"><img
