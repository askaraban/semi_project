...
if(replay==null) {//새글인 경우
	...
	reviewContent = Utility.escapeTag(mr.getParameter("reviewContent"));
	System.out.println("reviewContent = " + reviewContent);
} else {
	System.out.println("저기얌!");
	replay = Utility.escapeTag(mr.getParameter("replay"));
...
if(replay==null) {//새글인 경우
	...
	review.setReviewContent(replay);
}
