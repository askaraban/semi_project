						...
						<table>
							...
							<% for(QaDTO review : QaList){%>
								<tr style="padding-bottom: 10px;">
									...
									<td class="left" style="text-align:left"><a href="<%=request.getContextPath()%>/main_page/main.jsp?group=qa_page&worker=qa_detail&qaNum=<%=review.getQaNum()%>
									&productNum=<%=review.getQaProductNum()%>&pageNum=<%=pageNum%>"> <%=review.getQaSubject() %></a></td>
